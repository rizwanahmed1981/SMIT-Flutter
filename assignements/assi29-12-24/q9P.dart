...
List<Map<String, dynamic>> employes = [
  {"name": "Bilal", "salary": 80000, "department": "IT", "experience": 7},
  {"name": "Rizwan", "salary": 55000, "department": "IT", "experience": 1},
  {"name": "Qasim", "salary": 95000, "department": "HR", "experience": 6},
  {"name": "Saleem", "salary": 35000, "department": "Sales", "experience": 9},
  {"name": "Shoab", "salary": 30000, "department": "Sales", "experience": 3}
];
...
//printing final result
    print(
        "Mr. $name from $department Department is $promotion for promotion.\n His Annual salary is: Rs.$annualSalary");
  }
